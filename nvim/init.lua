...
vim.api.nvim_create_autocmd('LspAttach', {group = lsp_cfg_augroup,
  callback = function(ev)
    ...
    bufmap('n', '<Leader>i', telesope_builtin.lsp_implementations, 'Go to implementation')
    bufmap('n', '<Leader>t', telesope_builtin.lsp_type_definitions, 'Type definition')
    bufmap('n', '<Leader>ds', telesope_builtin.lsp_document_symbols, 'Document symbols')
    bufmap('n', '<Leader>ws', telesope_builtin.lsp_dynamic_workspace_symbols, 'Workspace symbols')
    bufmap('n', '<Leader>rn', vim.lsp.buf.rename, 'Rename')
    bufmap({ 'n', 'v' }, '<Leader>ca', vim.lsp.buf.code_action, 'Code action')
    bufmap({ 'n', 'v' }, '<Leader>cf', vim.lsp.buf.format, 'Code format')
    bufmap('n', 'gr', telesope_builtin.lsp_references, 'Go to references')
  end,
})
